...
<?php
    ...
    $msg = "Clicca sul link per confermare la mail: http://corsocyberdallavalle.altervista.org/Sito1/AttivaAccount.php?token=$token";   // Sostutuire con il proprio dominio di altervista
